...
const BUNDLED_SOURCE_CONFIGS: RawSourceConfig[] = [
  ...
  {
        id: 'saas-pages',
        display_name: 'SaaS Pages',
        category: 'web',
        access_method: 'sitemap',
        base_url: 'https://saaspages.xyz',
        rpm: 6,
        enabled: true,
        listing: { path: '/sites' },
        selectors: {
                listing_item: '.block-card',
                listing_item_link: 'a[href^="/sites/"]',
                listing_item_title: 'h1',
        },
  },
  {
        id: 'godly',
        display_name: 'Recent (formerly Godly)',
        category: 'motion',
        access_method: 'sitemap',
        base_url: 'https://recent.design',
        rpm: 6,
        enabled: true,
        listing: { sitemap_path: '/sitemap.xml', item_limit: 60 },
  },
  {
        id: 'banani',
        display_name: 'Banani',
        category: 'flows',
        access_method: 'headless',
        base_url: 'https://www.banani.co',
        rpm: 6,
        enabled: true,
        listing: {
                app_slugs: ['airbnb', 'arc-search', 'alltrails', 'blinkist', 'chatgpt', 'calm', 'things-3', 'pinterest', 'reddit', 'substack', 'tinder'],
  ...
  },
  {
        ...
        category: 'motion',
        access_method: 'sitemap',
        base_url: 'https://designspells.com',
        rpm: 6,
        enabled: true,
        listing: { sitemap_path: '/sitemap.xml', item_limit: 60 },
  },
